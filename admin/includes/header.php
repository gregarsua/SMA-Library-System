                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                           ...
                           <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Transactions <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="issue-book.php">Borrow New Book</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="return-issue-book.php">Return Borrowed Book</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-issued-books.php">View Borrowed Books</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Reg. Students <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-students.php">Add Students</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-reg-students.php">Manage Reg. Students</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-student-history.php">Student's History</a></li>
                                </ul>
                            </li> 
